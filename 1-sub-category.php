...
<html lang="en">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">View Sub Category Name </th>
  ...
  if(isset($_GET['id'])){
    $id = $_GET['id'] ;
    $get_scat_qry = "select * from subcategory where id=$id ";
  }else{
    $get_scat_qry = "select * from subcategory";
  }
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $qr1['subcategoryname'];?></td>
      <td></td>
      <td><a href=""><a href="1-scat-del.php?id=<?php echo $qr1['id'];?>">Delete</a></td>
    </tr>
...
<?php
  ...
  <tbody>
    <tr>
    <th scope="row">There is no data in sub category</td>
    </tr>
<?php 
}
